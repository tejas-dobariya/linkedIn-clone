      ...
      {props.articles.length === 0 ? (
        ...
        <Container>
          <Sharebox>
            ...
            <div>
              <button>
                <img src="/images/photo-icon.svg" alt="put image" />
                <span>Photo</span>
              </button>

              <button>
                <img src="/images/video-icon.svg" alt="put imagesput images" />
                <span>Video</span>
              </button>
            ...
            {props.articles.length > 0 &&
              props.articles.map((article, key) => (
                <Article key={key}>
                  <SharedActor>
                    <a>
                      <img src={article.actor.image} alt="put images" />
                      <div>
                  ...
                  <SocialAction>
                    <button>
                      <img src="/images/like-icon.svg" alt="put image" />
                      <span>Like</span>
                    </button>
                    <button>
